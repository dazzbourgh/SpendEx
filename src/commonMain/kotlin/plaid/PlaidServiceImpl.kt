...
class PlaidServiceImpl(
    ...
    override suspend fun createLinkToken(username: String): Either<String, String> = either {
    ...
    override suspend fun exchangePublicToken(publicToken: String): Either<String, PlaidAccessTokenResponse> = either {
        val config = configDao.loadPlaidConfig().bind()
        val request =
    ...
    override suspend fun getAccounts(accessToken: String): Either<String, PlaidAccountsResponse> = either {
        val config = configDao.loadPlaidConfig().bind()
        val request =
            AccountsGetRequest(
                clientId = config.client_id,
